...
export function MoreNewsCard({ article }: MoreNewsCardProps) {
  return (
    <Link
      ...
      className="group grid overflow-hidden rounded-[1.35rem] border border-[var(--color-line)] bg-white shadow-[0_10px_28px_rgba(9,18,44,0.06)] transition-transform duration-200 hover:-translate-y-0.5"
    >
      ...
      <div className="grid gap-3 p-5">
        ...
        <h2 className="text-[1.08rem] leading-[1.16] text-[var(--color-primary)]">
          {article.title}
        </h2>
      </div>
    </Link>
